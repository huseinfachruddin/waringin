          ...
          <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="custom-file">
                    <?php echo form_open_multipart('profile/update/'.$user['id']);?>
              ...
              <div class="card">
                ...
                <div class="card-body m-3">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Adress (prov,kota,kec,des,kode pos)</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?=base_url('profile/password/'.$user['id'])?>">
                        <div class="form-group">
